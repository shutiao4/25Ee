/**
 * @file    IMU660RA_CONFIG.c
 * @brief   IMU660RA DLE 固件配置数组
 *          此文件替代原 SEEKFREE_CONFIG.c
 *          提供 imu660ra_config_file[8192] 供 IMU660RA.c 下载固件用
 */

/* 兼容 8051 code 关键字, ARM 下无实际作用, 保留兼容性 */
#define code
#define _zf_device_config_h_

/**
 * @brief IMU660RA DLE (Digital Learning Engine) 固件配置数据
 * @note  该数组通过 I2C 写入 IMU660RA 的 INIT_DATA 寄存器,
 *        用于加载传感器内部 DSP 固件以实现自校准和滤波功能.
 *        数据由 IMU660RA 官方工具生成, 不可修改.
 */
